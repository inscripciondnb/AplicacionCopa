...
const CACHE_NAME = 'copa-integracion-shell-v3';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.hostname.includes('script.google.com') || url.hostname.includes('script.googleusercontent.com') || url.hostname.includes('chatgpt.site')) {
    return;
  }
